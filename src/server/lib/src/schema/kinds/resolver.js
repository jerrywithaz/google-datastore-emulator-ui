...
let KindsResolver = class KindsResolver {
    async getKinds({ datastore }) {
...
], KindsResolver.prototype, "getKinds", null);
KindsResolver = __decorate([
    (0, type_graphql_1.Resolver)()
], KindsResolver);
exports.default = KindsResolver;
