    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        function startClient() {
            if (DEV_MODE)
                ...
                spawnProcess("serve -s ".concat((0, path_1.join)(__dirname, "..", "src", "client", "build")));
        }
        function startServer() {
            if (DEV_MODE) {
                spawnProcess("PROJECT_ID=".concat(PROJECT_ID, " DATASTORE_EMULATOR_HOST=").concat(DATASTORE_EMULATOR_HOST, " PORT=").concat(PORT, " DATASTORE_BACKUP_BUCKET=").concat(DATASTORE_BACKUP_BUCKET, " DATASTORE_BACKUP_DIR=").concat(DATASTORE_BACKUP_DIR, " npm run dev:server"));
            }
            else {
                (0, server_1.default)({
